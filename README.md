...
2. A URL fica `https://caixeta94.github.io/Bouncer-Legal/`

## URLs para a ficha da Play Store

| Campo do Play Console | URL |
|---|---|
| Política de Privacidade | `https://caixeta94.github.io/Bouncer-Legal/privacidade.html` |
| Exclusão de conta (Data safety) | `https://caixeta94.github.io/Bouncer-Legal/exclusao-de-conta.html` |
| Site do desenvolvedor | `https://caixeta94.github.io/Bouncer-Legal/` |
...
- [ ] Os flags de feature em `games.json` batem com o que o app **realmente faz**
      (hoje: `offline_only, local_ranking`). Data Safety divergente do comportamento real é a causa
